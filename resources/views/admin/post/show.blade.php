...
@section('content')
    <div class="container-fluid">
        ...
        <a href="{{ route('admin.post.index') }}" class="btn btn-danger waves-effect">VOLTAR</a>
                ...
                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                              {{ $post->title }}
                                <small>Postado Por <strong> <a href="">{{ $post->user->name }}</a></strong> on {{ $post->created_at }}</small>
                            </h2>
                        </div>
                        <div class="body">
                            {!! $post->body !!}
